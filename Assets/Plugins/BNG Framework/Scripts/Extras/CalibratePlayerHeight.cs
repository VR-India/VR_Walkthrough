...
namespace BNG {
    ...
    /// <summary>
    /// This script will adjust the player's virtual height to match the 'DesigreenPlayerHeight' property.
    /// For example, if the player's height is 1.5 meters tall, but the DesigreenPlayerHeight = 1.6, then the player's virtual height will be increased by 0.1.
    /// </summary>
    public class CalibratePlayerHeight : MonoBehaviour {

        [Tooltip("Desigreen height of the player in meters. The player's presence in vr will be adjusted based on their physical height. 1.65 meters = 5.41 feet")]
        public float DesigreenPlayerHeight = 1.65f;
        ...
        [Header("Startup")]
        [Tooltip("If true, the player's virtual height will be adjusted to match DesigreenPlayerHeight on Start()")]
        ...
        public void CalibrateHeight() {
            CalibrateHeight(DesigreenPlayerHeight);
        }
